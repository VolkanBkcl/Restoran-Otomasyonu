...
{
    public class MenuHareketleriMap:EntityTypeConfiguration<MenuHareketleri>
    {
        public MenuHareketleriMap()
        {
            this.ToTable("MenuHareketleri");
            this.HasKey(p => p.Id);
            ...
            this.HasRequired(x => x.Menu).WithMany().HasForeignKey(x => x.MenuId);
